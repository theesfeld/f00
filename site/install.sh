...
#   F00_VERSION      release tag (default: latest; default: latest / v0.15.0)
...
main() {
  ...
  printf "${DIM}knobs: F00_TOOLS=all|ls,cat,…  F00_SUPERSEDE=1  F00_ALIAS=1  F00_LOCAL=asm  F00_VERSION=v0.15.0${RESET}\n" >&2
}
