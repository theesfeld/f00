 ...
 */
const THEME_LINK =
  '<link rel="stylesheet" href="https://f00.sh/theme/f00-theme-18.css" data-f00-theme="1" />';
...
export default {
  async fetch(request) {
    ...
    html = html.replace(
      ...
      "https://f00.sh/theme/f00-theme-18.css"
    );
    html = html.replace(
      /(?:https:\/\/f00\.sh)?\/theme\/f00-theme(?:-\d+)?\.css/g,
      "https://f00.sh/theme/f00-theme-18.css"
    ...
    if (!html.includes("f00-theme-18.css") && !html.includes("data-f00-theme")) {
