...
5. **Domains (ops, not site copy):** `f00.sh` hub · `coreutils.f00.sh` f00tils · `clun.f00.sh` clun · `cel.f00.sh` Cel Index · `trn.f00.sh` TRN · `heartbox.f00.sh` Heartbox · `joule.f00.sh` joule · `dist.f00.sh` R2 packages.
...
| joule | `released` | `$PROJECTS/joule` | https://joule.f00.sh/ | n/a (Pages `f00-joule`) |
