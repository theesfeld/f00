...
**Overall: 2.3× faster than GNU coreutils** (129% faster overall; geometric mean of 91 timed tools · 91 wins · median 2.17×).
<!-- bench-headline:end -->
...
<!-- bench-table:start -->
_CI / suite bench · `2026-07-24T13:49:42Z` · N=15 median · x86_64 · Linux 6.17.0-1020-azure_

| Tool | Command | GNU | f00 `--core` | vs GNU |
|------|---------|-----|--------------|--------|
| `true` | `f00-true --core` | 0.37 ms | **0.14 ms** | **~2.7×** |
| `basename` | `f00-basename --core /usr/bin/ls` | 0.55 ms | **0.17 ms** | **~3.3×** |
| `nproc` | `f00-nproc --core` | 0.54 ms | **0.13 ms** | **~4.1×** |
| `whoami` | `f00-whoami --core` | 0.56 ms | **0.13 ms** | **~4.2×** |
| `cat` | `f00-cat --core fixture.txt` | 0.64 ms | **0.17 ms** | **~3.7×** |
| `wc` | `f00-wc --core -l fixture.txt` | 0.56 ms | **0.37 ms** | **~1.5×** |
| `md5sum` | `f00-md5sum --core fixture.txt` | 0.89 ms | **0.29 ms** | **~3.0×** |
| `sha256sum` | `f00-sha256sum --core fixture.txt` | 0.79 ms | **0.37 ms** | **~2.1×** |
| `sort` | `f00-sort --core fixture.txt` | 1.00 ms | **0.57 ms** | **~1.8×** |
| `ls` | `f00-ls --core -1 dir` | 0.64 ms | **0.35 ms** | **~1.8×** |
<!-- bench-table:end -->
