...
```bash
# pin version
curl -fsSL https://f00.sh/install.sh | F00_VERSION=v0.15.6 bash
...
Release assets for `v0.15.6` include tarball, **deb**, **rpm**, and **Arch** packages.
...
curl -fsSLO https://github.com/theesfeld/f00/releases/download/v0.15.6/f00_0.15.6_amd64.deb
sudo dpkg -i f00_0.15.6_amd64.deb

# Fedora / RHEL example
curl -fsSLO https://github.com/theesfeld/f00/releases/download/v0.15.6/f00-0.15.6-1.x86_64.rpm
sudo rpm -Uvh f00-0.15.6-1.x86_64.rpm

# Arch example (release package)
curl -fsSLO https://github.com/theesfeld/f00/releases/download/v0.15.6/f00-0.15.6-1-x86_64.pkg.tar.zst
sudo pacman -U f00-0.15.6-1-x86_64.pkg.tar.zst
```
