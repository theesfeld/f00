...
> **Theme (ONE shared CSS):** [https://f00.sh/theme/f00-theme-34.css](https://f00.sh/theme/f00-theme-34.css) — domain-level for all `*.f00.sh`. Heart-Shaped Box contrasts · Bleach boxes. Product CSS = layout only.
...
Layout: splash + project cards only. Installers live on each project site.

**Release rule:** a f00 project gets a landing card when it has a real release.
