...
Security fixes target the latest released version on the default branch (`main`).
Older major versions receive fixes only when explicitly maintained.
...
You will receive an acknowledgment when the report is received.
Please allow reasonable time for investigation before any public disclosure.
