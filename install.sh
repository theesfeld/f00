...
#   F00_VERSION      release tag (default: latest; default: latest / v0.15.6)
...
main() {
  printf "\n${BOLD}f00tils${RESET} ${DIM}installer · binary f00 · 0.15.6 multicall${RESET}\n" >&2
  ...
  printf "${DIM}knobs: F00_TOOLS=all|ls,cat,…  F00_SUPERSEDE=1  F00_ALIAS=1  F00_LOCAL=asm  F00_VERSION=v0.15.6${RESET}\n" >&2
}
