...
vecho:  db "f00-echo (f00) 0.15.5", 10, "License: MIT · https://f00.sh", 10, 0
...
hpwd:
    ...
    db "      --csv      CSV result", 10, 10
    db "f00 suite · pure assembly · MIT · https://f00.sh", 10, 0
vpwd:   db "f00-pwd (f00) 0.15.5", 10, "License: MIT · https://f00.sh", 10, 0
...
hsleep:
    ...
    db "      --csv      CSV result", 10, 10
    db "f00 suite · pure assembly · MIT · https://f00.sh", 10, 0
vsleep: db "f00-sleep (f00) 0.15.5", 10, "License: MIT · https://f00.sh", 10, 0
...
hseq:
    ...
    db "      --csv      CSV result", 10, 10
    db "f00 suite · pure assembly · MIT · https://f00.sh", 10, 0
vseq:   db "f00-seq (f00) 0.15.5", 10, "License: MIT · https://f00.sh", 10, 0
...
hwc:
    ...
    db "      --csv      CSV result", 10, 10
    db "f00 suite · pure assembly · MIT · https://f00.sh", 10, 0
vwc:    db "f00-wc (f00) 0.15.5", 10, "License: MIT · https://f00.sh", 10, 0
...
hhead:
    ...
    db "      --csv      CSV result", 10, 10
    db "f00 suite · pure assembly · MIT · https://f00.sh", 10, 0
vhead:  db "f00-head (f00) 0.15.5", 10, "License: MIT · https://f00.sh", 10, 0
...
htail:
    ...
    db "      --csv      CSV result", 10, 10
    db "f00 suite · pure assembly · MIT · https://f00.sh", 10, 0
vtail:  db "f00-tail (f00) 0.15.5", 10, "License: MIT · https://f00.sh", 10, 0
...
htee:
    ...
    db "      --csv      CSV result", 10, 10
    db "f00 suite · pure assembly · MIT · https://f00.sh", 10, 0
vtee:   db "f00-tee (f00) 0.15.5", 10, "License: MIT · https://f00.sh", 10, 0
