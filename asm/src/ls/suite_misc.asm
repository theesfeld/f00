...
s_help: db "help",0
s_ver: db "version",0
v_chroot: db "f00-chroot (f00) 0.15.0-beta.1",10,"License: MIT · https://f00.sh",10,0
v_stty: db "f00-stty (f00) 0.15.0-beta.1",10,"License: MIT · https://f00.sh",10,0
v_stdbuf: db "f00-stdbuf (f00) 0.15.0-beta.1",10,"License: MIT · https://f00.sh",10,0
v_runcon: db "f00-runcon (f00) 0.15.0-beta.1",10,"License: MIT · https://f00.sh",10,0
...
section .rodata
nm_chcon: db "chcon",0
v_chcon: db "f00-chcon (f00) 0.15.0-beta.1",10,"License: MIT · https://f00.sh",10,0
h_chcon:
