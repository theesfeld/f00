...
jk_ok: db "ok",0
v_common: db "f00-hash (f00) 0.15.1",10,"License: MIT · https://f00.sh",10,0
h_md5sum:
...
v_md5sum: db "f00-md5sum (f00) 0.15.1",10,"License: MIT · https://f00.sh",10,0
h_sha1sum:
    ...
    db "f00 suite · pure assembly · MIT · https://f00.sh",10,0
v_sha1sum: db "f00-sha1sum (f00) 0.15.1",10,"License: MIT · https://f00.sh",10,0
h_sha256sum:
    ...
    db "f00 suite · pure assembly · MIT · https://f00.sh",10,0
v_sha256sum: db "f00-sha256sum (f00) 0.15.1",10,"License: MIT · https://f00.sh",10,0
h_sha224sum:
    ...
    db "f00 suite · pure assembly · MIT · https://f00.sh",10,0
v_sha224sum: db "f00-sha224sum (f00) 0.15.1",10,"License: MIT · https://f00.sh",10,0
h_sha384sum:
    ...
    db "      --csv      CSV result",10,10
    db "f00 suite · pure assembly · MIT · https://f00.sh",10,0
v_sha384sum: db "f00-sha384sum (f00) 0.15.1",10,"License: MIT · https://f00.sh",10,0
h_sha512sum:
    ...
    db "      --csv      CSV result",10,10
    db "f00 suite · pure assembly · MIT · https://f00.sh",10,0
v_sha512sum: db "f00-sha512sum (f00) 0.15.1",10,"License: MIT · https://f00.sh",10,0
h_b2sum:
    ...
    db "      --csv      CSV result",10,10
    db "f00 suite · pure assembly · MIT · https://f00.sh",10,0
v_b2sum: db "f00-b2sum (f00) 0.15.1",10,"License: MIT · https://f00.sh",10,0
h_cksum:
    ...
    db "f00 suite · pure assembly · MIT · https://f00.sh",10,0
v_cksum: db "f00-cksum (f00) 0.15.1",10,"License: MIT · https://f00.sh",10,0
h_sum:
    ...
    db "      --csv      CSV result",10,10
    db "f00 suite · pure assembly · MIT · https://f00.sh",10,0
v_sum: db "f00-sum (f00) 0.15.1",10,"License: MIT · https://f00.sh",10,0
h_base64:
    ...
    db "f00 suite · pure assembly · MIT · https://f00.sh",10,0
v_base64: db "f00-base64 (f00) 0.15.1",10,"License: MIT · https://f00.sh",10,0
h_basenc:
    ...
    db "      --csv      CSV result",10,10
    db "f00 suite · pure assembly · MIT · https://f00.sh",10,0
v_basenc: db "f00-basenc (f00) 0.15.1",10,"License: MIT · https://f00.sh",10,0
h_dircolors:
    ...
    db "f00 suite · pure assembly · MIT · https://f00.sh",10,0
v_dircolors: db "f00-dircolors (f00) 0.15.1",10,"License: MIT · https://f00.sh",10,0
align 4
md5_T:
...
v_base32: db "f00-base32 (f00) 0.15.1",10,"License: MIT · https://f00.sh",10,0
h_base32:
