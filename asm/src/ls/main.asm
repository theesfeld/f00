...
help_msg:
    ...
    db 10
    db "Default is modern mode (color, table columns, git).", 10
    ...
    db "      --icons[=STYLE]        prefix icons off by default; opt-in:", 10
    db "                             ascii|glyph|emoji|nerd|always|never (off under --core)", 10
